                ...
                <CardContent className="pt-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">support@churchconnect.com</p>
                      <p className="text-muted-foreground">info@churchconnect.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Grace City, GC 12345</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
